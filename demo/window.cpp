...
void Window::selectCaster()
{
    m_selection |= 0x1;
}

void Window::selectTarget()
{
    m_selection |= 0x2;
}
...
void Window::mouseReleased(QMouseEvent *event)
{
...
void Window::mouseMoved(QMouseEvent *event)
{
...
void Window::wheelRotated(QWheelEvent *event)
{
    if (m_drag)
